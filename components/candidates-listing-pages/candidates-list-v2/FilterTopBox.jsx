        ...
        <div className="inner-box">
          ...
          <ul className="job-info">
            ...
            <li>
              ...
              {candidate.hourlyRate} جنيه / ساعة
            </li>
          </ul>
          {/* End candidate-info */}
  ...
  return (
    <>
      <div className="ls-switcher">
        <div className="showing-result flex justify-content-between">
        ...
        <div className="sort-by">
          ...
          <select
            ...
            className="chosen-single form-select px-5"
            value={sort}
          >
            <option value="">فرز افتراضي</option>
            <option value="asc">جديد</option>
            <option value="des">قديم</option>
          </select>
          {/* End select */}

          <select
            className="chosen-single form-select ms-3 px-5"
